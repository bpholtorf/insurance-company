					...
					<div class="row">
						...
						<div class="col-xs-12 col-md-5 col-lg-3">
							<div class="panel panel-default height">
								...
								<div class="panel-body">
									<strong>Policy Name:</strong> No<br> <strong>Policy
										Number</strong> ${cusPo.policyNumber }<br> <strong>Pharmacy
										Amount Left:</strong> ${cusPo.pamountLeft }<br> <strong>Hospital
										Amount Left:</strong> ${cusPo.hamountLeft }<br>
