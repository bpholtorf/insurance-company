...
<body>
	...
	<div id="sidebar" class="nav-collapse ">
		...
		<ul class="sidebar-menu" id="nav-accordion">
			...
			<li class="sub-menu"><a class="active" href="javascript:;">
				...
				<ul class="sub">
					<li class="active"><a href="<c:url value='/staff/viewAll' />">Staff
							List</a></li>
	...
	<!--main content start--> <section id="main-content"> <section
		class="wrapper">
	<h3>
		<i class="fa fa-angle-right"></i> Edit Staff Information
	</h3>
				...
				<form:form action="${updateAction}"
					...
					<div class="form-group">
						...
						<c:when test="${staff.gender eq 'female' }" >
							<form:radiobutton path="gender" id="optionsRadios2" value="male" disabled="true"/>
							Male
							<form:radiobutton path="gender" id="optionsRadios1"
								value="female"   checked="checked"/>
							Female
						</c:when>
						<c:otherwise>
						    <form:radiobutton path="gender" id="optionsRadios2" value="male"  checked="checked"/>
							Male
							<form:radiobutton path="gender" id="optionsRadios1"
					...
					<div class="form-group">
						<label class="col-sm-2 control-label col-lg-2">Date of
							Birth</label>
						<div class="col-lg-5">
							<fmt:formatDate value="${staff.dateOfBirth}" type="date"
								pattern="MM/dd/yyyy" var="theFormattedDate" />
							<form:input type="text" id="datepicker" class="form-control"
								path="dateOfBirth" value="${theFormattedDate}" readonly="true"/>
	...
	<script
		src="/InsuranceSystem/pages/assets/js/jquery-ui-1.9.2.custom.min.js"></script>
	...
	<script type="text/javascript"
		src="/InsuranceSystem/pages/assets/js/bootstrap.js"></script>
	<script type="text/javascript"
