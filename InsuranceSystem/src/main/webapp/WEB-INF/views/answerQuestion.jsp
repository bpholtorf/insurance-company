...
<html lang="en">
  ...
  <section id="container" >
    ...
    <script src="/InsuranceSystem/pages/assets/js/jquery.ui.touch-punch.min.js"></script>
  ...
  <script>
    	            ...
    	            success: function(response) {  
    	                  bootbox.prompt({
    	                      ...
    	                      callback: function(result) {
    	                        if (result.toUpperCase() === response.answer.toUpperCase()) {
    	                         
    	                        } else {
    	                        showQuestion(response.question,response.answer);
    	                        }
    	                      }
     ...
     function showQuestion(question,answer)
     {
    	 bootbox.prompt({
             ...
             value:"",
             callback: function(result) {
               if (result.toUpperCase() === answer.toUpperCase()) {
