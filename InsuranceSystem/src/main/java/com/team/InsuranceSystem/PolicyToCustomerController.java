...
@Controller
public class PolicyToCustomerController {
  ...
  private PolicyToCustomerDB generatePolicyCustomer(int cid,int pid,String policyNumber,double premium,double amountLeft,double deductibleLeft,Date dateFrom,Date dateTo){
  ...
  public String addPolicyToCustomer(@RequestParam(value="policyId",required=true) String policyId,
	  ...
	  PolicyToCustomerDB pc=generatePolicyCustomer(cid,pid,policyNum,premium,amountL,deductible,dateFrom1,dateTo1);
